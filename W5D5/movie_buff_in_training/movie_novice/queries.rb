...
def top_titles
  ...
  # select returns relation object, can take in a block and used like Array#select or modifies SELECT statement
  # for query so that certain fields are retrieved
  # where accepts string or array or hash
...
def pulp_fiction_actors
  ...
  Actor.joins(:movies).select(:id, :name).where('title = \'Pulp Fiction\'')
end
